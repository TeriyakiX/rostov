                ...
                <div class="comparison__content">
                    ...
                    <div class="comparison__tabsWrp">
                        <div class="comparison__tabs">
                            <div class="comparison__tab link" role="button" data-tab="Категория товаров 1" data-active>
                                Категория товаров 1
                                <span class="comparison__tabCount">(10)</span>
                            </div>
                            <div class="comparison__tab link" role="button" data-tab="Категория товаров 2">Категория
                                товаров 2
                                <span class="comparison__tabCount">(6)</span>
                            </div>
                            <div class="comparison__tab link" role="button" data-tab="Категория товаров 3">Категория
                                товаров 3
                                <span class="comparison__tabCount">(17)</span>
                            </div>
                            <div class="comparison__tab link" role="button" data-tab="Категория товаров 4">Категория
                                товаров 4
                    ...
                    <div class="comparison__tabBlock" data-tabblock="Категория товаров 1" data-active>
                                                    ...
                                                    <div class="card comparison__card">
                                                        <div class="card__imgWrp"><a class="card__imgBox ibg" href="#">
                                                                <picture>
                                                                    <source type="image/webp"
                                                                            srcset="./img/productsLayout//p4.webp">
                                                            ...
                                                            <div class="card__delete" role="button">
                                                                <svg>
                                                                    <use
                                                                        xlink:href="{{ asset('img/sprites/sprite-mono.svg#cancel') }}"></use>
                                                                </svg>
                                                            </div>
                                                        </div>
                                                        <div class="card__title"><a class="link"
                                                                                    href="">Металлочерепица</a></div>
                                                        ...
                                                        <div class="card__controllers">
                                                            ...
                                                            <div class="card__icons">
                                                                <div class="card__icon card__icon--like" role="button"
                                                                     tabindex="0">
                                                                    <svg>
                                                                        <use
                                                                ...
                                                                <div class="card__icon card__icon--stat" role="button"
                                                                     tabindex="0">
                                                                    <svg>
                                                                        <use
                        ...
                        <div class="comparison__parameters">
                            <div class="comparison__settings">
                                <div class="checkbox">
                                    <input class="checkbox__input" id="chkbox" autocomplete="off" type="checkbox"
                                           name="form[]">
                            ...
                            <div class="comparisonGrid">
                                <div class="comparisonGrid__col comparisonGrid__col--left">
                                    <div class="comparison__parameterRow comparison__parameterRow--name bold">Параметр
                                    </div>
                                    <div class="comparison__parameterRow comparison__parameterRow--name bold">Параметр
                                    </div>
                                    <div class="comparison__parameterRow comparison__parameterRow--name bold">Параметр
                                        ...
                                        <div class="swiper-container compareParametersSlider _swiper">
                                            <div class="swiper-wrapper compareParametersSlider__wrapper">
                                                <div class="swiper-slide compareParametersSlider__slide">
                                                    <div class="comparison__parameterRow">Значение параметра<span
                                                            class="comparison__parameterName">Параметр</span></div>
                                                    <div class="comparison__parameterRow">Значение параметра<span
                                                            class="comparison__parameterName">Параметр</span></div>
                                                    <div class="comparison__parameterRow">Значение параметра<span
                                                            class="comparison__parameterName">Параметр</span></div>
                        ...
                        <div class="comparison__back"><a class="comparison__backBtn btn"
                                                         href="/posts/katalog">
                                Назад к товарам
                            </a></div>
                    </div>
                    <div class="comparison__tabBlock" data-tabblock="Категория товаров 2">
                        ...
                        <div class="comparison__back"><a class="comparison__backBtn btn" href="#">Назад к товарам</a>
                        </div>
                    </div>
