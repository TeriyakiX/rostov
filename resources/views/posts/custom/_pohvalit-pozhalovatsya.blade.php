        ...
        <form class="cta__form" id="consultationForm" action="{{ route('index.send_mail') }}" method="post" data-ajax="true">
            ...
            <div class="ctaForm">
                ...
                <div class="ctaForm__body">
                    ...
                    <div class="formRow">
                        <div class="inpBox">
                            <label for="consent_2" class="ctaForm__label" style="cursor: pointer">
                                <input type="checkbox" id="consent_2" name="consent" required data-consent style="pointer-events: none">
