    ...
    <div class="popup__content">
        <div class="popup__body popup__body_md">
            ...
            <div class="popup__box">
                ...
                <form  action="{{route('index.send_mail')}}" method="post"  class="_form">
                    ...
                    <div class="formRow">
                        <div class="inpBox">
                            <select class="input" id="numb" autocomplete="off" name="delivery_method" onchange="if($(this).val() == 2){$('#buy-popup-address').show();}else{$('#buy-popup-address').hide()}">
