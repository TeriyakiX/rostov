                                    ...
                                    <div class="ordering__personDataBody">
                                        ...
                                        <div class="formRow">
                                            ...
                                            <div class="inpBox inpBox33">
                                                ...
                                                <input class="input" id="numb" autocomplete="off" type="text" name="phone_number" value="{{ old('phone_number') ?: ($userData ? $userData->name : null) }}" required>
                                            </div>
                                            <div class="inpBox inpBox33">
...
{{--                                            </div>--}}
                        ...
                        <div class="ordering__side">
                            ...
                            </div><a class="ordering__help btn" href="#">Помощь менеджера</a>
                        </div>
                    </div>
                </div>
            </div>
