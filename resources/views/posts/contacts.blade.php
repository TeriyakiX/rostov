...
@section('content')
    ...
    <div class="container">
        <div class="show">
            ...
            <div class="show__center">
                ...
                <div class="show__btn"><span><a href="http://mkrostov.ru/posts/o-kompanii">3D-ТУР</a></span></div>
            </div>
            <div class="show__caption">
    ...
    <div class="minfo">
        ...
        <div class="minfo__left minfo__left--revert">
            <div style="position:relative;overflow:hidden;"><a href="https://yandex.ru/maps/39/rostov-na-donu/?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;">Ростов‑на‑Дону</a><a href="https://yandex.ru/maps/39/rostov-na-donu/?ll=39.620498%2C47.231526&mode=usermaps&source=constructorLink&um=constructor%3A77133d5c90fd390dd4be9be55db2aef2588c55f717b392d715ba91c3f31b8757&utm_medium=mapframe&utm_source=maps&z=13" style="color:#eee;font-size:12px;position:absolute;top:14px;">Карта Ростова-на-Дону с улицами и номерами домов — Яндекс Карты</a><iframe src="https://yandex.ru/map-widget/v1/?ll=39.620498%2C47.231526&mode=usermaps&source=constructorLink&um=constructor%3A77133d5c90fd390dd4be9be55db2aef2588c55f717b392d715ba91c3f31b8757&z=13" width="100%" height="400" frameborder="0" allowfullscreen="true" style="position:relative;"></iframe></div>
		</div>
    </div>
