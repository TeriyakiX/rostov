...
return [
    ...
    */
    ...
    'phone' => 'Поле :attribute введено неверно.',
...
//    'required_unless' => 'Поле :attribute обязательно для заполнения, когда :other не равно :values.',
    ...
    'custom' => [
        'phone' => [
            'unique' => 'Пользователь с данным номером телефона уже зарегистрирован.'
        ]
    ],
    'attributes' => [
        'address' => 'Адрес',
        ...
        'confirm' => 'политикой конфеденциальности',
        'delivery_type_id' => 'способ доставки',
    ],
    'https_string_required' => 'Адрес ссылки должен начинаться с https://',
    'banner_start_date' => 'Дата окончания не может быть раньше, чем дата старта',
    'promotion_start_date' => 'Значение даты не может быть раньше, чем текущая дата',
    'promotion_end_date' => 'Значение даты не может быть раньше, чем дата старта',
    'values' => [
        'date_of_birth' => [
            'today' => 'Сегодня',
            'yesterday' => 'Вчера',
