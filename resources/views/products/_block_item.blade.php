            ...
            <div class="card__controllers">
                ...
                <div class="card__icons">
                    <div class="card__icon card__icon--basket"
                         ...
                         data-length="{{ isset($sliderProduct->length_list) ? explode(';', $sliderProduct->length_list)[0] : null }}"
                         data-total-square="{{ isset($sliderProduct->length_list) ? ($sliderProduct->list_width_useful / 1000) * (floatval(explode(';', $sliderProduct->length_list)[0]) / 1000) : null }}"
                         data-start-price-promo="{{ $sliderProduct->is_promo ?  $sliderProduct->promo_price : 0 }}"
                         data-start-price="{{ $sliderProduct->price }}"
                         data-attribute-prices="{{$sliderProduct->attribute_prices ? $sliderProduct->attribute_prices : 0}}"
                         data-color="{{ $sliderProduct->colors_list[0] ?? null }}"
                         data-coating="{{$sliderProduct->coatings_id[0] ?? null }}"
                         data-quantity="1"
