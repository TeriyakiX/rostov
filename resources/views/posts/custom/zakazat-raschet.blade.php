<div class="cta cooperation__cta">
    <img class="cta__img" src="{{ asset('img/cooperation/close-up-detail.png') }}" alt="img"
         loading="lazy" decoding="async" style="max-height: 504px" referrerPolicy="no-referrer">
    <!-- Call to action-->
