                    ...
                    <div class="ctaForm">
                        ...
                        <div style="display:flex;margin-top: 20px">
                            ...
                            <p style="line-height: 1.5;color: #bebebe;margin: 0">
                                ...
                                <span style="color: #006bde;">Правилами оплаты продукции с использованием банковских карт.</span>
                            </p>
                        </div>
                    </div>
                </form>
...
@else
    ...
    <div>
        <button class="btn service_raschet_btn" type="button" style="margin-bottom: 20px;">
