      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              Vue.$toast.error(error.response.data.message); // axios.post('/log', {
            ...
            case 18:
              Vue.$toast.error('Something went wrong. Try again later.'); // axios.post('/log', {
              //     code: null,
              //     stack: error,
              //     message: 'Error'
              // });
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().get('/').then(function (_ref3) {
              var data = _ref3.data;
