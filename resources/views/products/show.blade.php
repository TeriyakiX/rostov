                        ...
                        <div class="prodCard__content">
                            <div class="prodCard__side">
                                <div class="prodCard__sideBody">
                                                           ...
                                                           data-fslightbox>
                                                            <div class="ratio__box">
                                                                <picture>
                                                                    ...
                                                                    <img class="coatCard-slider__pic"
                                                                         src="{{ asset('upload_images/' . $photo->path) }}"
                                                                         alt="img0">
                                                                </picture>
                                                            </div>
                                                        </a>
                                                       ...
                                                       data-fslightbox>
                                                        <div class="ratio__box">
                                                            <picture>
                                                                ...
                                                                <img class="coatCard-slider__pic"
                                                                     src="{{ asset('upload_images/' . $firstPhoto->path) }}"
                                                                     alt="img0">
                                                            </picture>
                                                        </div>
                                                    </a>
                                                       ...
                                                       data-fslightbox>
                                                        <div class="ratio__box">
                                                            <picture>
                                                                <source type="image/webp"
                                                                        srcset="{{ asset('upload_images/' . $photo->path) }}">
                                                                <img class="coatCard-thumbnails__pic"
                                                                     src="{{ asset('upload_images/' . $photo->path) }}"
                                                                     alt="img1">
                                                            </picture>
                                                        </div>
                                            ...
                                            <div class="coatCard-slider__controls">
                                                <div class="coatCard-slider__btn coatCard-slider__btn_prev">
                                                    <svg class="coatCard-slider__arrow">
                                                        <use
                                                            xlink:href="{{ asset('img/sprites/sprite-mono.svg#arrow_left') }}"></use>
                                                    </svg>
                                                </div>
                                                <div class="coatCard-slider__btn coatCard-slider__btn_next">
                                                    <svg class="coatCard-slider__arrow">
                                                        <use
                                                            xlink:href="{{ asset('img/sprites/sprite-mono.svg#arrow_right') }}"></use>
                                                    </svg>
                                                </div>
                                            </div>
                                        </div>
                                                           ...
                                                           data-fslightbox>
                                                            <div class="ratio__box">
                                                                <picture>
                                                                    <source type="image/webp"
                                                                            srcset="{{ asset('upload_images/' . $photo->path) }}">
                                                                    <img class="prodCard-slider__pic"
                                                                         src="{{ asset('upload_images/' . $photo->path) }}"
                                                                         alt="img0">
                                                                </picture>
                                                            </div>
                                    ...
                                    <div class="prodCard__art prodCard__art--mobile">Код
                                        товара: {{ $product->vendor_code }}</div>

                                    <div class="prodCard__anchors">
                                        <div class="prodCard__anchor-wrapper">
                            ...
                            <form class="addToCartForm" action="{{ route('index.cart.add') }}" method="POST"
                                ...
                                <input type="hidden" name="attribute_prices"
                                       value="{{$product->attribute_prices ? $product->attribute_prices : 0}}">
                                ...
                                <div class="prodCard__body">
                                    <h2 class="prodCard__title prodCard__title--desktop"
                                        data-da=".prodCard__content, 992, 0">
                                        {{ $product->title }}
                                        <script src="https://yastatic.net/share2/share.js"></script>
                                        <div class="ya-share2 share-icon" data-curtain data-limit="0"
                                             data-more-button-type="short"
                                    ...
                                    <div class="prodCard__art prodCard__art--desktop">Код
                                        товара: {{ $product->vendor_code }}</div>
                                                ...
                                                @else
                                                    <div id="productCalc" class="productCalc"
                                                            ...
                                                            @foreach($product->getLengthList() as $length)
                                                                <div data-num="{{$loop->iteration}}"
                                                                    ...
                                                                    <div class="productCalc__col--wrapper">
                                                                        <div
                                                                            class="productCalc__col productCalc__col--count">
                                                                            <div class="productCalc__named">Количество
                                                                                листов
                                                                            </div>
                                                                        ...
                                                                        <div
                                                                            class="productCalc__col productCalc__col--total">
                                                            ...
                                                            <div class="productCalc__party">
                                                                @if($product->show_calculator)
                                                                    <div class="add__list" id="addList">
                                                                        <div
                                                                            style="color: rgba(0, 107, 222, 1); margin-right: 5px;font-weight: bold;">
                                                                            +
                                                                        </div>
                                                        ...
                                                        <div class="productCalc__btnGroup">
                                                            ...
                                                            <div class="productCalc__btnWrp">
                                                                <div
                                                                    class="productCalc__btn btn popup-link addToCartLinkOneClick"
                                                                    role="button"
                                                                    href="#buy"
                                                                    tabindex="0">
                                                                    Купить в 1 клик
                                                        ...
                                                        <div class="prodCard__descBody">
                                                            <div class="prodCard__descBenefits">
                                                                <div class="prodCard__descBenefit">
                                                                    <img src="{{ asset('img/icons/pantone.png') }}"
                                                                         class="prodCard__descImg"/>

                                                                    <div>
                                                                        <h3 class="prodCard__descTitle">Ассортимент
                                                                            цветов</h3>

                                                                        <p>Разъяснение заголовка делает блок
                                                                            информативным и полезным.</p>
                                                                    </div>
                                                                </div>
                                                                <div class="prodCard__descBenefit">
                                                                ...
                                                                <div class="prodCard__descBenefit">
                                                                    <img src="{{ asset('img/icons/guaranteed.png') }}"
                                                                         class="prodCard__descImg"/>

                                                                    <div>
                                                                        <h3 class="prodCard__descTitle">
                                                                            Преимущество</h3>
