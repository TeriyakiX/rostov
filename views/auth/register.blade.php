        ...
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <form action="{{ route('auth.register') }}" method="POST">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="password" name="password" value="" class="form-control form-control-xl" placeholder="Пароль">
                        <div class="form-control-icon">
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class="text-gray-600">Есть аккаунт? <a href="{{ route('auth.loginForm') }}" class="font-bold">Вход</a>.</p>
